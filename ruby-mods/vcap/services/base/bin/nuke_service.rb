...
default_configs = {
  ...
  :mssql   => File.expand_path("../../mssql/config/mssql_gateway.yml", __FILE__),
}
...
OptionParser.new do |opts|
  ...
  opts.on("-s", "--service ARG", [:redis, :mysql, :mongodb, :neo4j, :mssql],  "Look for default configs for the supplied service [redis, mysql, mongodb, neo4j, mssql]") do |opt|
